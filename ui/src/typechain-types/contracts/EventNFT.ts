...
export interface EventNFTInterface extends utils.Interface {
  functions: {
...
export interface EventNFT extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: EventNFTInterface;
  ...
  functions: {
    ...
    mintedCount(overrides?: CallOverrides): Promise<[number]>;

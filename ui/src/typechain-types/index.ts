...
export type { EventManager } from "./contracts/EventManager";
export { EventManager__factory } from "./factories/contracts/EventManager__factory";
export type { EventNFT } from "./contracts/EventNFT";
export { EventNFT__factory } from "./factories/contracts/EventNFT__factory";
